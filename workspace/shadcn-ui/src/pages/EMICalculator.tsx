      ...
      <header className="bg-white shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link to="/emi-calculator" className="text-slate-700 hover:text-yellow-600 font-medium transition-colors" aria-current="page">EMI Calculator</Link>
            <Link to="/contact" className="text-slate-700 hover:text-yellow-600 font-medium transition-colors">Contact</Link>
          </nav>
        </div>
      </header>
      <section className="py-16 px-4 text-center">
        <h1 className="text-4xl font-bold text-slate-800 mb-6">EMI Calculator</h1>
        <p className="text-xl text-slate-600">Plan your monthly EMI</p>
      </section>
    </div>
  );
}
